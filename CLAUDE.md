...
- **来自 subAgent 的 tooluse 不能 fork** → [MessageBubble.renderItemToBubble](src/webview/components/ChatDrawer/ChatPanel/MessageBubble.tsx):subAgent 消息中的 tooluse 块不渲染 fork 按钮,防止 fork 到无法寻址的消息位置
